...
## Project Structure
    ...
    ├── testapiautocatalog_116363  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_116363`
...
2. Clone this repo and `cd testapiautocatalog_116363`
